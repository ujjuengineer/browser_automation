# NOTE : TESTED FOR CREATING INDEXING 
# For indexing after volume creation !!

# login and click on the process button whose folder path is given 
# it will start indexing by reading the files from the given folder path 

"""
extension of version 3.2 
collect all the portal alert and display them at last
"""
